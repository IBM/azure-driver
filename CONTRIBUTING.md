...
- Check the existing list of [issues](https://github.com/IBM/azure-driver/issues) to see if the bug you've found has already been reported.
...
- Name your branch `issue/<issue number>` where `issue number` corresponds to the unique ID of the issue e.g. work on [issue#115](https://github.com/IBM/azure-driver/issues/115) was completed on branch [issue/115](https://github.com/IBM/azure-driver/pull/116)
...
- Create the [pull request on Github](https://github.com/IBM/azure-driver/compare) with `base: develop` and `compare: your-branch`. 
