...
class VNETResourceManager(AzureResourceManager):
    ...
    def remove(self, resource_id, lifecycle_name, driver_files, system_properties, resource_properties, request_properties, associated_topology, azure_location):
        self.__create_resource_name(system_properties, self.get_resource_name(system_properties), None)
    ...
    def __create_resource_name(self, system_properties, resource_name, operation_source_name):
    ...
    def createvnetpeering(self, resource_id, lifecycle_name, driver_files, system_properties, resource_properties, request_properties, associated_topology, azure_location):
        ...
        if stack_id is None:
            ...
            resource_name = self.__create_resource_name(system_properties, self.get_resource_name(system_properties), "vnet_peering")
            try:
                ...
                arm_template, arm_parameters = self.prepare_deployment_artifacts(system_properties, resource_properties, request_properties, 'arm_vnet_peering.json', 'arm_vnet_peering_parameters.json')
